...
cont_premium::cont_premium(float suma_, const  std::string &moneda_, const  std::string &iban_, Titular * titular_, int c,int taxa_init_):Cont( suma_,  moneda_,  iban_,  titular_, c), taxa_init(taxa_init_) {
